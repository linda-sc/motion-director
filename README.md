# Fable Motion Director Prototype
...
- Motion clips can be exported as plain JSON through `src/motion-format.js`, which keeps the prototype compatible with a future `voidpet-poc/apps/mmo` integration.
